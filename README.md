# Wind Turbine Fault Detection and Prediction
...
│
├── pyproject.toml     <- Project configuration file with package metadata for wind_turbine_fault_detection_and_prediction
